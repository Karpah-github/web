  ...
  <modal :open="props.open" :close="props.close" class="overflow-y-hidden">
    ...
    >
      <div class="text-left">
        ...
        <h4 class="text-md font-medium">You are about to remove an admin</h4>
        <p class="font-light text-sm py-2">
          Do you want to delete this admin? deleting would remove this admin
          from your team completely
        </p>
      </div>
