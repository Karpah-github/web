  ...
  <div class="md:flex gap-20">
    ...
    <form action="" class="md:w-6/12 pt-4">
      ...
      <div class="form-input">
        ...
        <div class="form-field flex gap-2 flex-wrap">
          ...
          <input
            ...
            @keyup.enter="addTag"
            type="text"
            class="placeholder:text-[#B3B3B3] w-full ml-2"
            placeholder="+ Add tag"
          />
        </div>
      </div>
      <div class="flex pb-6 justify-between items-center">
        ...
        <label class="switch">
          <input type="checkbox" v-model="productInfo.reviewStatus" checked />
          ...
          <div class="form-input">
            ...
            <div class="form-field flex justify-between">
              <input
                ...
                name="bust"
                class="w-full"
                v-model="productInfo.measurement.bust"
              />
          ...
          <div class="form-input">
            ...
            <div class="form-field flex justify-between">
              <input
                ...
                name="Waist"
                class="w-full"
                v-model="productInfo.measurement.waist"
              />
              <p class="text-neutral text-sm font-light">Inches</p>
            </div>
          </div>
          <div class="form-input">
            ...
            <div class="form-field flex justify-between">
              <input
                ...
                name="Hips"
                class="w-full"
                v-model="productInfo.measurement.hip"
              />
              <p class="text-neutral text-sm font-light">Inches</p>
            </div>
          </div>
          <div class="form-input">
            ...
            <div class="form-field flex justify-between">
              <input
                ...
                name="Height"
                class="w-full"
                v-model="productInfo.measurement.height"
              />
              <p class="text-neutral text-sm font-light">Inches</p>
            </div>
          </div>
      ...
      <div>
        <div
          class=""
          v-for="(highlight, index) in productInfo.highlights"
          :key="index"
        >
          <div class="flex pb-4 justify-between items-center">
          ...
          <div class="form-input">
            ...
            <input
              ...
              class="form-field"
              v-model="productInfo.highlights[index].title"
          ...
          <div class="form-input">
            ...
            <textarea
              ...
              placeholder="Placeholder"
              v-model="productInfo.highlights[index].details"
            ></textarea>
...
const addHighlight = () => {
  ...
  productInfo.value.highlights.push(highlight);
  console.log(productInfo.value.highlights);
};
