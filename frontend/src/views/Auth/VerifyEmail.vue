...
<template>
  <div class="flex h-screen">
    ...
    <div
      class="pt-8 px-8 mx-auto flex md:w-6/12 flex-col justify-center w-full"
    >
      <div class="mb-4 w-full md:w-9/12 mx-auto">
        <h6 class="text-dark text-xl mb-2 font-semibold">Verify Email</h6>
        <p class="font-light text-[#4D4D4D]">
          We sent a verification link to the email you provided. click on the
          link to verify your email to start using karpah
        </p>
      </div>
